class Level3 extends Phaser.Scene {
    ...
    create() {
        ...
        let enemy2Counter = 0;
        enemy2.createMultiple({key: 'enemy2', quantity: 4})
        ...
        let enemy3Counter = 0;
        enemy3.createMultiple({key: 'enemy3', quantity: 2})
        let enemySpawn3 = this.time.addEvent({delay: 800, loop: true, callback: () => {
            if(enemy3.spawn(Phaser.Math.RND.between(200, 900), -200, 0, 800, .5)) {enemy3Counter++;}
            if(enemy3Counter == 12) {
                enemySpawn3.remove();
                //console.log('wave cleared');
            }
        ...
        this.physics.add.overlap(this.player, [enemy, enemy2, enemy3], (player, enemy) => {
